<template>
  <div class="main">
    <el-card>
      <span style="font-weight: 700; font-size: 18px">Draft completion email preview</span>
    </el-card>
          ...
          <div class="baseinfo-card">
            <el-form ref="formDataRef" :model="formData" :rules="rules" style="font-weight: 700" class="baseinfo-form" label-width="320px">
              ...
              <el-form-item label="Trademark Case">
                <el-checkbox v-model="formData.chooseTrademark">Register a Case with Self-created Instructing Department</el-checkbox>
              </el-form-item>
              ...
              <h2 style="width: calc(90vw - 20px); margin: 40px 0 10px 0; border-bottom: 1px dashed #ccc; padding-bottom: 10px; font-size: 18px">Case</h2>

              <el-form-item label="Case Master Case or Sub Case">
                <el-radio-group v-model="formData.subCase">
                  <el-radio label="Register a new Case Master Case"></el-radio>
                  <el-radio label="Register a new sub-case under a current Case Master Case"></el-radio>
                </el-radio-group>
              </el-form-item>

              <el-form-item label="Case Master Case Number">
              ...
              <el-form-item label="Handling Staff eid">
                <el-input size="small" v-model="formData.handingEidStaff" />
              </el-form-item>

              <el-form-item label="Descriptions ">
                <el-input v-model="formData.descriptions" :rows="3" type="textarea" maxlength="200" show-word-limit />
              </el-form-item>
              ...
              <el-form-item label="Email Subject">
                <el-radio-group v-model="formData.emailSubject">
                  <el-radio label="Yes"></el-radio>
                  <el-radio label="No"></el-radio>
                </el-radio-group>
              </el-form-item>

              <el-form-item label="Email Preview" class="quill-conatiner" style="margin-top: 20px">
                <quill :content="formData.content" @quillEditorChange="quillEditorChange" />
              </el-form-item>

              <h2 style="width: calc(90vw - 20px); margin: 40px 0 10px 0; border-bottom: 1px dashed #ccc; padding-bottom: 10px; font-size: 18px">Please insert c.c. email address(es)</h2>

              <el-form-item label="Please insert c.c. email address(es)">
                <el-input size="small" v-model="formData.caseHidden" />
              </el-form-item>
